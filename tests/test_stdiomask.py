...
class test_main(unittest.TestCase):
    def test_getpass(self):
        ...
        self.assertEqual(stdiomask.getpass(), 'swordfish')
        ...
        self.assertEqual(stdiomask.getpass(), 'mary')

        # Test every typable character.
        pauseThenType('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ`1234567890-=~!@#$%^&*()_+,./;\'<>?:"[]{}\n')
        self.assertEqual(stdiomask.getpass(), 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ`1234567890-=~!@#$%^&*()_+,./;\'<>?:"[]{}')
